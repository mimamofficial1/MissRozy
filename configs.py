...
SESSION_NAME = str(environ.get('SESSION_NAME', 'MissRozyXbot'))
MULTI_CLIENT = False
...
BANNED_CHANNELS = list(set(int(x) for x in str(getenv("BANNED_CHANNELS", "-1002111679640")).split())) 
STREAM_LOGS = environ.get('STREAM_LOGS','-1002338165303')
SESSION = environ.get('SESSION','MissRozyXbot')
...
class Config(object):
	...
	BOT_TOKEN = os.environ.get("BOT_TOKEN","7477277308:AAHeCf5z5ErCBhPY_JMfvgqiZL7MWH9NE-w")
	BOT_USERNAME = os.environ.get("BOT_USERNAME" , "MissRozyXbot")
	DB_CHANNEL = int(os.environ.get("DB_CHANNEL", -1002338165303))
	BOT_OWNER = int(os.environ.get("BOT_OWNER", "6139759254"))
	DATABASE_URL = os.environ.get("DATABASE_URL","mongodb+srv://muzaffarimammuhammad:muzaffarimammuhammad@cluster0.pr5n5.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
	UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "-1002111679640")
	LOG_CHANNEL = os.environ.get("LOG_CHANNEL", "-1002338165303")
	...
	LAZY_PIC = os.environ.get("LAZY_PIC","https://files.catbox.moe/f63tuu.jpg")
  ...
  # LP_CUSTOM_TEMPLATE= os.environ.get("LP_CUSTOM_TEMPLATE","{file_name} - example \n\n Please Upadate this template acording to you @LazyDeveloperr ")
	BANNED_CHAT_IDS = list(set(int(x) for x in os.environ.get("BANNED_CHAT_IDS", "-1002338165303").split()))
...
🧑🏻‍💻 **DΞVΞLФPΞЯ:** [꧁𓊈𒆜𝖒𝖎𝖒𝖆𝖒_𝖔𝖋𝖋𝖎𝖈𝖎𝖆𝖑𒆜𓊉꧂](https://t.me/mimam_officialx)

👥 **šupp⊕r† gr⊕up:** [MRN「 Support Group 」](https://t.me/Tv_Serial_Search_Group)

📢 **U͢p͢d͢a͢t͢e͢s͢ C͢h͢a͢n͢n͢e͢l͢:** [ChillFliz | TV Shows](https://t.me/ALL_TV_SERIAL_BACKUP)
"""
	ABOUT_DEV_TEXT = f"""
🧑🏻‍💻 <a href='https://t.me/mimam_officialx'>**ミ★- ꧁𓊈𒆜𝖒𝖎𝖒𝖆𝖒_𝖔𝖋𝖋𝖎𝖈𝖎𝖆𝖑𒆜𓊉꧂ -★彡** </a>

<a href=''https://t.me/mimam_officialx>꧁𓊈𒆜𝖒𝖎𝖒𝖆𝖒_𝖔𝖋𝖋𝖎𝖈𝖎𝖆𝖑𒆜𓊉꧂</a> ɪꜱ ꜱᴜᴘᴇʀ ɴᴏᴏʙ 😎. ᴊᴜꜱᴛ ʟᴇᴀʀɴɪɴɢ ꜰʀᴏᴍ ᴏꜰꜰɪᴄɪᴀʟ ᴅᴏᴄꜱ. ᴘʟᴇᴀꜱᴇ ᴅᴏɴᴀᴛᴇ ᴛʜᴇ ᴅᴇᴠᴇʟᴏᴘᴇʀ ꜰᴏʀ ᴋᴇᴇᴘɪɴɢ ᴛʜᴇ ꜱᴇʀᴠɪᴄᴇ ᴀʟɪᴠᴇ.
